---
pagetitle: "Enrico Wegner — Econometrician & Macroeconomist"
description: "PhD Candidate in Econometrics at Maastricht University. Macroeconometrics, time series econometrics, and the Transmission Channel Analysis framework."
toc: false
---

::: {.hero}
::: {.hero-photo}
![](assets/profile.jpg){fig-alt="Portrait of Enrico Wegner"}
:::
::: {.hero-text}
::: {.badge-jobmarket}
<span class="dot"></span> On the 2026 / 2027 Job Market
:::
# Enrico Wegner
[PhD Candidate in Econometrics · Maastricht University (SBE)]{.hero-role}
...
In my dissertation, I develop new methods for analysing how policy transmits through the economy, both in general-equilibrium models and empirically. These methods decompose a policy's total effect into the contributions of specific **transmission channels**. I break this work down [at three levels of depth](#three-levels) further down the page.

Previously a PhD intern in the Monetary Analysis Division at the **Bank of England**, and a consultant at the **OECD**.

::: {.hero-actions}
[View research →](research.qmd){.btn-accent}
[Download CV](assets/cv-enrico-wegner.pdf){.btn-outline}
<span class="hero-socials"><a class="social-icon" href="https://github.com/enweg" target="_blank" rel="noopener" aria-label="GitHub" title="GitHub"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a><a class="social-icon" href="https://www.linkedin.com/in/enrico-wegner-2bb8a717b/" target="_blank" rel="noopener" aria-label="LinkedIn" title="LinkedIn"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a><a class="social-icon" href="https://orcid.org/0009-0003-3537-9858" target="_blank" rel="noopener" aria-label="ORCID" title="ORCID"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zM7.369 4.378c.525 0 .947.431.947.947s-.422.947-.947.947a.95.95 0 0 1-.947-.947c0-.525.422-.947.947-.947zm-.722 3.038h1.444v10.041H6.647V7.416zm3.562 0h3.9c3.712 0 5.344 2.653 5.344 5.025 0 2.578-2.016 5.025-5.325 5.025h-3.919V7.416zm1.444 1.303v7.444h2.297c3.272 0 4.022-2.484 4.022-3.722 0-2.016-1.284-3.722-4.097-3.722h-2.222z"/></svg></a><a class="social-icon" href="https://scholar.google.com/citations?user=5vjXTtAAAAAJ" target="_blank" rel="noopener" aria-label="Google Scholar" title="Google Scholar"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5.242 13.769L0 9.5 12 0l12 9.5-5.242 4.269C17.548 11.249 14.978 9.5 12 9.5c-2.977 0-5.548 1.748-6.758 4.269zM12 10a7 7 0 1 0 0 14 7 7 0 0 0 0-14z"/></svg></a></span>
:::
:::
:::

<!-- Upcoming talks. Hidden by default; a small script (see _partials/talks.html)
     drops any talk whose `data-until` date has passed, sorts the rest, and reveals
     this block only if at least one upcoming talk remains. To add a talk, copy one
     `.talk` block below. `data-date` = start (ISO, for ordering); `data-until` =
     last day it should show (ISO; omit for single-day events). To link an event,
     make its name a link: [Name](https://…){.talk-name}. See README. -->
::: {.upcoming-talks}
[Upcoming Talks]{.talks-eyebrow}

::: {.talk data-date="2026-08-17" data-until="2026-08-21"}
[EEA-ESEM Congress](https://eea-esem-congresses.org/sessions/monetary-policy-transmission){.talk-name}
[17–21 August 2026]{.talk-when}
:::

::: {.talk data-date="2026-08-25"}
[Virtual Israel Macro Seminar (VIMM)](https://www.vimacro.org/enrico-wegner-transmission-channel-analysis-dynamic-models){.talk-name}
[25 August 2026]{.talk-when}
:::

::: {.talk data-date="2026-07-26" data-until="2026-07-31"}
[3rd Frankfurt Summer School]{.talk-name}
[26-31 July 2026]{.talk-when}
:::
...
::: {#three-levels .callout-levels}
::: {.cl-head}
::: {.cl-headtext}
[My PhD research, explained on 3 levels]{.cl-title}
[Below I explain my research on three levels: one for a general audience, one for undergraduate economics students, and one for the technical graduate reader. Research communication matters a lot to me, but explaining technical work clearly is hard. If any part could be clearer, I'd welcome your [feedback](mailto:e.wegner@maastrichtuniversity.nl).]{.cl-intro}
:::
<!-- [first draft]{.tag-draft} -->
:::

::: {.panel-tabset .level-tabs}

## General Audience

[General Audience]{.level-label}
